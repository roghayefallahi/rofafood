function Definition() {
  return (
    <div className="mt-[100px]">
      <h3 className="text-2xl text-[#53c60b] my-6 mx-0">Who We Are?</h3>
      <p className="text-[1.1rem] font-medium lg:text-justify my-[18px] mx-0 leading-[30px]">
      RofaFood company was founded in 2009 by Garrett Camp and Travis
